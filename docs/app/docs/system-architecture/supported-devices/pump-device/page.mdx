...
|----------------------|--------------------------------------------------------------------------------|--------------|----------------------------------------------------------------------------------------|
| `flow`               | Monitors the rate of fluid flow through the pump.                              | No           | [See details](/docs/system-architecture/supported-channels/flow-channel)               |
| `switcher`           | Controls the on/off state of the pump.                                         | No           | [See details](/docs/system-architecture/supported-channels/switcher-channel)           |
...
| `leak`              | Detects leaks in the pump or connected systems.  | No           | [See details](/docs/system-architecture/supported-channels/leak-channel)              |
| `pressure`          | Monitors the pressure of the fluid being pumped. | No           | [See details](/docs/system-architecture/supported-channels/pressure-channel)          |
