...
|----------------------|---------------------------------------------------------------------------------------|--------------|----------------------------------------------------------------------------------------|
| `light`              | Controls the lighting functionality, including power, brightness, and color settings. | Yes          | [See details](/docs/system-architecture/supported-channels/light-channel)              |
...
| `illuminance`       | Measures the ambient light level in the room. | No           | [See details](/docs/system-architecture/supported-channels/illuminance-channel)       |
