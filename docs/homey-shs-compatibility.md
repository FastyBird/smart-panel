...
| Sanitized fixture corpus                              | Eleven live plus one synthetic device fixture               | No blocking corpus evidence                                      |
...
| HTTPS `4860` ping and authenticated reads  | Unsupported; not claimed            | A credential-free standard Node TLS probe failed protocol negotiation with `EPROTO`; no HTTPS response, certificate, or authenticated read occurred  |
