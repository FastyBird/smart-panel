...
| `type`       | `Enum`        | `generic/irrigation/shower-head/water-faucet` | -        | RO (Read-Only)  |
...
- Possible values:
    ...
    - `shower-head`: A valve integrated into a shower head.
    - `water-faucet`: A valve associated with a water faucet.
