...
import 'package:fastybird_smart_panel/plugins/spaces-home-control/models/sensor_state/sensor_state.dart';
...
class SpacesService extends ChangeNotifier {
  ...
  Future<LightingIntentResult?> setRoleWhite(
    ...
    return _spaceStateRepository.setRoleWhite(spaceId, role, white);
  }
