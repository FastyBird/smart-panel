...
const String _tileType = 'tiles-device-preview';
...
void registerTilesDevicePreviewPlugin() {
  ...
  registerTileViewMapper(TileType.devicePreview, (TileModel tile, List<DataSourceView> dataSources) {
  ...
  registerTileWidgetMapper(TileType.devicePreview, (tile) {
