...
class SimulatorChannelModel extends ChannelModel {
  SimulatorChannelModel({
    required super.id,
  ...
  factory SimulatorChannelModel.fromJson(Map<String, dynamic> json) {
