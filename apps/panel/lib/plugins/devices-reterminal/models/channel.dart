...
class ReTerminalChannelModel extends ChannelModel {
  ReTerminalChannelModel({
    required super.id,
  ...
  factory ReTerminalChannelModel.fromJson(Map<String, dynamic> json) {
    DevicesModuleChannelCategory category =
        DevicesModuleChannelCategory.fromJson(
      json['category'],
    );
