...
class ReTerminalDeviceModel extends DeviceModel {
  final String? _variant;

  ReTerminalDeviceModel({
    required super.id,
    super.category = DevicesModuleDeviceCategory.terminal,
    required super.name,
    super.description,
    super.icon,
    super.roomId,
    ...
    required String? variant,
        ...
        super(
          type: reTerminalDeviceType,
        );

  String? get variant => _variant;

  factory ReTerminalDeviceModel.fromJson(Map<String, dynamic> json) {
    DevicesModuleDeviceCategory category =
        DevicesModuleDeviceCategory.fromJson(
      json['category'],
    );
