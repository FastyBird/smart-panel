class DisplaysModuleConstants {
  // Socket event names
  static const String moduleWildcardEvent = 'DisplaysModule.*';

  static const String displayCreatedEvent = 'DisplaysModule.Display.Created';
