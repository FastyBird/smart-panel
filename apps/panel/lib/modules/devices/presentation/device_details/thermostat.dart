...
class ThermostatDeviceDetail extends StatefulWidget {
  ...
  @override
  State<ThermostatDeviceDetail> createState() =>
      _ThermostatDeviceDetailState();
}

class _ThermostatDeviceDetailState
    extends State<ThermostatDeviceDetail> {
  ...
  bool get _isActive {
    ...
    if (_device.coolerChannel?.isCooling ?? false) {
      return true;
    }
