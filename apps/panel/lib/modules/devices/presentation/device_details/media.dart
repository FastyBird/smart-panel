...
class MediaDeviceDetail extends StatefulWidget {
	final MediaDeviceView _device;
	final VoidCallback? onBack;

	const MediaDeviceDetail({
		super.key,
		required MediaDeviceView device,
		this.onBack,
	}) : _device = device;

	@override
	State<MediaDeviceDetail> createState() => _MediaDeviceDetailState();
}
...
class _MediaDeviceDetailState extends State<MediaDeviceDetail> {
	...
	void initState() {
		...
		try {
			...
			if (kDebugMode) {
				debugPrint('[MediaDeviceDetail] Failed to get DeviceControlStateService: $e');
			}
		}
	}
