...
/// Property view for brightness values.
/// Supports both numeric (0-100) and enum values.
class BrightnessChannelPropertyView extends ChannelPropertyView {
  ...
  /// Returns the numeric brightness value (0-100) if available.
