...
class AirDehumidifierDeviceDetailPage extends StatelessWidget {
  final ScreenService _screenService = locator<ScreenService>();

  final AirDehumidifierDeviceDataModel device;
  final AirDehumidifierDeviceCapability capability;

  AirDehumidifierDeviceDetailPage({
    super.key,
