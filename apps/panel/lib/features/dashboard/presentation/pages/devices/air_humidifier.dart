...
class AirHumidifierDeviceDetailPage extends StatelessWidget {
  final ScreenService _screenService = locator<ScreenService>();

  final AirHumidifierDeviceDataModel device;
  final AirHumidifierDeviceCapability capability;

  AirHumidifierDeviceDetailPage({
    super.key,
