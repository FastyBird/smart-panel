...
class TelevisionDeviceDetailPage extends StatelessWidget {
  final ScreenService _screenService = locator<ScreenService>();

  final TelevisionDeviceDataModel device;
  final TelevisionDeviceCapability capability;

  TelevisionDeviceDetailPage({
    super.key,
