...
class AirConditionerDeviceDetailPage extends StatelessWidget {
  final ScreenService _screenService = locator<ScreenService>();

  final AirConditionerDeviceDataModel device;
  final AirConditionerDeviceCapability capability;

  AirConditionerDeviceDetailPage({
    super.key,
