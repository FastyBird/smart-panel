...
class RobotVacuumDeviceDetailPage extends StatelessWidget {
  final ScreenService _screenService = locator<ScreenService>();

  final RobotVacuumDeviceDataModel device;
  final RobotVacuumDeviceCapability capability;

  RobotVacuumDeviceDetailPage({
    super.key,
