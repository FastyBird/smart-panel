...
class SwitcherDeviceDetailPage extends StatelessWidget {
  final ScreenService _screenService = locator<ScreenService>();

  final SwitcherDeviceDataModel device;
  final SwitcherDeviceCapability capability;

  SwitcherDeviceDetailPage({
    super.key,
