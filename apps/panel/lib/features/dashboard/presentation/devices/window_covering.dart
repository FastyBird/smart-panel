...
class WindowCoveringDeviceDetailPage extends StatefulWidget {
  final WindowCoveringDeviceView _device;
  final DeviceDetailPageView? _page;

  const WindowCoveringDeviceDetailPage({
    super.key,
  ...
  @override
  State<WindowCoveringDeviceDetailPage> createState() =>
      _WindowCoveringDeviceDetailPageState();
}
