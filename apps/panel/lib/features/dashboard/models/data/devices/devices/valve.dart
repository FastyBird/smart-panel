...
class ValveDeviceDataModel extends DeviceDataModel {
  ValveDeviceDataModel({
    required super.id,
    required super.name,
    super.description,
    super.icon,
    ...
    super.invalid,
          ...
          category: DeviceCategoryType.valve,
        );

  factory ValveDeviceDataModel.fromJson(Map<String, dynamic> json) {
    return ValveDeviceDataModel(
      id: json['id'],
      name: json['name'],
