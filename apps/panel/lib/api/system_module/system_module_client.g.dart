...
part of 'system_module_client.dart';
...
class _SystemModuleClient implements SystemModuleClient {
  _SystemModuleClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<HttpResponse<SystemResSystemInfo>> getSystemModuleSystemInfo() async {
    ...
    final _options = _setStreamType<HttpResponse<SystemResSystemInfo>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<SystemResThrottleStatus>>
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<SystemResThrottleStatus>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
