...
import '../models/system_module_res_system_info.dart';
import '../models/system_module_res_throttle_status.dart';
...
abstract class SystemModuleClient {
  ...
  Future<HttpResponse<SystemModuleResSystemInfo>> getSystemModuleSystemInfo();
  ...
  Future<HttpResponse<SystemModuleResThrottleStatus>> getSystemModuleSystemThrottle();
}
