...
_$DevicesModuleChannelImpl _$$DevicesModuleChannelImplFromJson(
    ...
    _$DevicesModuleChannelImpl(
      ...
      controls: (json['controls'] as List<dynamic>)
          .map((e) =>
              DevicesModuleChannelControl.fromJson(e as Map<String, dynamic>))
          .toList(),
      properties: (json['properties'] as List<dynamic>)
          .map((e) =>
              DevicesModuleChannelProperty.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$DevicesModuleChannelImplToJson(
