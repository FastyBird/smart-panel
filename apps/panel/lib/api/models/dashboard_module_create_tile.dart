...
part 'dashboard_module_create_tile.freezed.dart';
part 'dashboard_module_create_tile.g.dart';

/// Base schema for creating a dashboard tile, containing shared attributes such as position and size.
@Freezed()
class DashboardModuleCreateTile with _$DashboardModuleCreateTile {
  const factory DashboardModuleCreateTile({
    ...
    @Default(false)
    bool hidden,
  }) = _DashboardModuleCreateTile;
  
  factory DashboardModuleCreateTile.fromJson(Map<String, Object?> json) => _$DashboardModuleCreateTileFromJson(json);
}
