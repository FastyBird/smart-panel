...
_$DevicesThirdPartyPluginThirdPartyChannelPropertyImpl
    _$$DevicesThirdPartyPluginThirdPartyChannelPropertyImplFromJson(
...
Map<String, dynamic>
    _$$DevicesThirdPartyPluginThirdPartyChannelPropertyImplToJson(
            _$DevicesThirdPartyPluginThirdPartyChannelPropertyImpl instance) =>
        <String, dynamic>{
          'id': instance.id,
          'type': instance.type,
          'category':
