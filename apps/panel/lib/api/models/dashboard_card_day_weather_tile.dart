...
part 'dashboard_card_day_weather_tile.freezed.dart';
part 'dashboard_card_day_weather_tile.g.dart';

/// A dashboard tile associated with a specific device.
@Freezed()
class DashboardCardDayWeatherTile with _$DashboardCardDayWeatherTile {
  const factory DashboardCardDayWeatherTile({
    ...
    @Default('weather-day')
    String type,
  }) = _DashboardCardDayWeatherTile;
  
  factory DashboardCardDayWeatherTile.fromJson(Map<String, Object?> json) => _$DashboardCardDayWeatherTileFromJson(json);
}
