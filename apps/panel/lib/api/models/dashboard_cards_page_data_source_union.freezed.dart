...
class _$DashboardCardsPageDataSourceUnionDeviceChannelImpl
  ...
  @override
  String toString() {
    return 'DashboardCardsPageDataSourceUnion.deviceChannel(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, device: $device, channel: $channel, property: $property, icon: $icon, type: $type)';
  }
