...
part 'dashboard_page_device_tile.freezed.dart';
part 'dashboard_page_device_tile.g.dart';

/// A dashboard tile associated with a specific device.
@Freezed()
class DashboardPageDeviceTile with _$DashboardPageDeviceTile {
  const factory DashboardPageDeviceTile({
    ...
    @Default('device')
    String type,
  }) = _DashboardPageDeviceTile;
  
  factory DashboardPageDeviceTile.fromJson(Map<String, Object?> json) => _$DashboardPageDeviceTileFromJson(json);
}
