...
part 'devices_module_create_device_channel.freezed.dart';
part 'devices_module_create_device_channel.g.dart';

/// Schema for creating a new channel, representing a functional category of a device such as temperature, light, or motion.
@Freezed()
class DevicesModuleCreateDeviceChannel with _$DevicesModuleCreateDeviceChannel {
  const factory DevicesModuleCreateDeviceChannel({
    ...
    String? description,
  }) = _DevicesModuleCreateDeviceChannel;
  
  factory DevicesModuleCreateDeviceChannel.fromJson(Map<String, Object?> json) => _$DevicesModuleCreateDeviceChannelFromJson(json);
}
