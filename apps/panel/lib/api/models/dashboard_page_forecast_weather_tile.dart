...
part 'dashboard_page_forecast_weather_tile.freezed.dart';
part 'dashboard_page_forecast_weather_tile.g.dart';

/// A dashboard tile associated with a specific device.
@Freezed()
class DashboardPageForecastWeatherTile with _$DashboardPageForecastWeatherTile {
  const factory DashboardPageForecastWeatherTile({
    ...
    @Default(0)
    int colSpan,
  }) = _DashboardPageForecastWeatherTile;
  
  factory DashboardPageForecastWeatherTile.fromJson(Map<String, Object?> json) => _$DashboardPageForecastWeatherTileFromJson(json);
}
