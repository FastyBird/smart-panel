...
part 'devices_home_assistant_plugin_home_assistant_channel.freezed.dart';
part 'devices_home_assistant_plugin_home_assistant_channel.g.dart';

/// A Home Assistant channels used to communicate with Home Assistant instance.
@Freezed()
class DevicesHomeAssistantPluginHomeAssistantChannel with _$DevicesHomeAssistantPluginHomeAssistantChannel {
  const factory DevicesHomeAssistantPluginHomeAssistantChannel({
