...
_$DevicesThirdPartyPluginCreateThirdPartyChannelImpl
    _$$DevicesThirdPartyPluginCreateThirdPartyChannelImplFromJson(
...
Map<String, dynamic>
    _$$DevicesThirdPartyPluginCreateThirdPartyChannelImplToJson(
            _$DevicesThirdPartyPluginCreateThirdPartyChannelImpl instance) =>
        <String, dynamic>{
          'id': instance.id,
          'type': instance.type,
