...
DashboardPageTimeTile _$DashboardPageTimeTileFromJson(
    Map<String, dynamic> json) {
  return _DashboardPageTimeTile.fromJson(json);
}

/// @nodoc
mixin _$DashboardPageTimeTile {
  ...
  $DashboardPageTimeTileCopyWith<DashboardPageTimeTile> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DashboardPageTimeTileCopyWith<$Res> {
  factory $DashboardPageTimeTileCopyWith(DashboardPageTimeTile value,
          $Res Function(DashboardPageTimeTile) then) =
      _$DashboardPageTimeTileCopyWithImpl<$Res, DashboardPageTimeTile>;
  @useResult
  $Res call(
      {String id,
      int row,
...
/// @nodoc
class _$DashboardPageTimeTileCopyWithImpl<$Res,
        $Val extends DashboardPageTimeTile>
    implements $DashboardPageTimeTileCopyWith<$Res> {
  _$DashboardPageTimeTileCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DashboardPageTimeTileImplCopyWith<$Res>
    implements $DashboardPageTimeTileCopyWith<$Res> {
  factory _$$DashboardPageTimeTileImplCopyWith(
          _$DashboardPageTimeTileImpl value,
          $Res Function(_$DashboardPageTimeTileImpl) then) =
      __$$DashboardPageTimeTileImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$DashboardPageTimeTileImplCopyWithImpl<$Res>
    extends _$DashboardPageTimeTileCopyWithImpl<$Res,
        _$DashboardPageTimeTileImpl>
    implements _$$DashboardPageTimeTileImplCopyWith<$Res> {
  __$$DashboardPageTimeTileImplCopyWithImpl(_$DashboardPageTimeTileImpl _value,
      $Res Function(_$DashboardPageTimeTileImpl) _then)
      : super(_value, _then);
...
class _$DashboardPageTimeTileImpl implements _DashboardPageTimeTile {
  ...
  factory _$DashboardPageTimeTileImpl.fromJson(Map<String, dynamic> json) =>
      _$$DashboardPageTimeTileImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DashboardPageTimeTileImplCopyWith<_$DashboardPageTimeTileImpl>
      get copyWith => __$$DashboardPageTimeTileImplCopyWithImpl<
          _$DashboardPageTimeTileImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DashboardPageTimeTileImplToJson(
      this,
    );
  }
}
