...
part 'pages_cards_plugin_card.freezed.dart';
part 'pages_cards_plugin_card.g.dart';

/// Represents a card in the dashboard page, with its associated tiles and data sources.
@Freezed()
class PagesCardsPluginCard with _$PagesCardsPluginCard {
  const factory PagesCardsPluginCard({
    ...
    @Default(0)
    int order,
  }) = _PagesCardsPluginCard;
  
  factory PagesCardsPluginCard.fromJson(Map<String, Object?> json) => _$PagesCardsPluginCardFromJson(json);
}
