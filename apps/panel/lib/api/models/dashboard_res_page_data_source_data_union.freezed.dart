...
class _$DashboardResPageDataSourceDataUnionDeviceChannelImpl
  ...
  @override
  String toString() {
    return 'DashboardResPageDataSourceDataUnion.deviceChannel(id: $id, type: $type, createdAt: $createdAt, updatedAt: $updatedAt, device: $device, channel: $channel, property: $property, icon: $icon, page: $page)';
  }
