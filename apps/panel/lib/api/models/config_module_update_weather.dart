...
part 'config_module_update_weather.freezed.dart';
part 'config_module_update_weather.g.dart';

/// Schema for partial update settings for weather configuration, allowing changes to location, temperature unit, and API key.
@Freezed()
class ConfigModuleUpdateWeather with _$ConfigModuleUpdateWeather {
  const factory ConfigModuleUpdateWeather({
  ...
  }) = _ConfigModuleUpdateWeather;
  
  factory ConfigModuleUpdateWeather.fromJson(Map<String, Object?> json) => _$ConfigModuleUpdateWeatherFromJson(json);
}
