...
@JsonEnum()
enum DevicesModuleChannelPropertyCategory {
  @JsonValue('generic')
  generic('generic'),
  @JsonValue('active')
  active('active'),
  ...
  const DevicesModuleChannelPropertyCategory(this.json);

  factory DevicesModuleChannelPropertyCategory.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
