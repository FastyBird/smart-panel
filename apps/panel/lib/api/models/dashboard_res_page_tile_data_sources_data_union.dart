...
part 'dashboard_res_page_tile_data_sources_data_union.freezed.dart';
part 'dashboard_res_page_tile_data_sources_data_union.g.dart';

@Freezed(unionKey: 'type')
sealed class DashboardResPageTileDataSourcesDataUnion with _$DashboardResPageTileDataSourcesDataUnion {
  @FreezedUnionValue('device-channel')
  const factory DashboardResPageTileDataSourcesDataUnion.deviceChannel({
