...
part 'devices_res_device_data_union.freezed.dart';
part 'devices_res_device_data_union.g.dart';

@Freezed(unionKey: 'type')
sealed class DevicesResDeviceDataUnion with _$DevicesResDeviceDataUnion {
  @FreezedUnionValue('third-party')
  const factory DevicesResDeviceDataUnion.thirdParty({
    ...
    @Default('third-party')
    String type,
  }) = DevicesResDeviceDataUnionThirdParty;

  
  factory DevicesResDeviceDataUnion.fromJson(Map<String, Object?> json) => _$DevicesResDeviceDataUnionFromJson(json);
}
