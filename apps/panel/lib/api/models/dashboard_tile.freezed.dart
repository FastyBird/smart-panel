...
class _$DashboardTileImpl implements _DashboardTile {
  ...
  @override
  String toString() {
    return 'DashboardTile(id: $id, type: $type, parent: $parent, row: $row, col: $col, dataSource: $dataSource, createdAt: $createdAt, updatedAt: $updatedAt, rowSpan: $rowSpan, colSpan: $colSpan)';
  }
...
abstract class _DashboardTile implements DashboardTile {
  const factory _DashboardTile(
      ...
      @JsonKey(name: 'col_span') final int colSpan}) = _$DashboardTileImpl;
