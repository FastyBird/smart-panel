...
DashboardDeviceTile _$DashboardDeviceTileFromJson(Map<String, dynamic> json) {
  return _DashboardDeviceTile.fromJson(json);
}

/// @nodoc
mixin _$DashboardDeviceTile {
  ...
  /// Serializes this DashboardDeviceTile to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DashboardDeviceTile
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DashboardDeviceTileCopyWith<DashboardDeviceTile> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DashboardDeviceTileCopyWith<$Res> {
  factory $DashboardDeviceTileCopyWith(
          DashboardDeviceTile value, $Res Function(DashboardDeviceTile) then) =
      _$DashboardDeviceTileCopyWithImpl<$Res, DashboardDeviceTile>;
  @useResult
  $Res call(
      {String id,
      int row,
...
/// @nodoc
class _$DashboardDeviceTileCopyWithImpl<$Res, $Val extends DashboardDeviceTile>
    implements $DashboardDeviceTileCopyWith<$Res> {
  _$DashboardDeviceTileCopyWithImpl(this._value, this._then);
...
class __$$DashboardDeviceTileImplCopyWithImpl<$Res>
    extends _$DashboardDeviceTileCopyWithImpl<$Res, _$DashboardDeviceTileImpl>
...
/// @nodoc
@JsonSerializable()
class _$DashboardDeviceTileImpl implements _DashboardDeviceTile {
  ...
  @override
  String toString() {
    return 'DashboardDeviceTile(id: $id, row: $row, col: $col, dataSource: $dataSource, createdAt: $createdAt, updatedAt: $updatedAt, device: $device, icon: $icon, rowSpan: $rowSpan, colSpan: $colSpan, type: $type)';
  }
...
abstract class _DashboardDeviceTile implements DashboardDeviceTile {
  const factory _DashboardDeviceTile(
  ...
  factory _DashboardDeviceTile.fromJson(Map<String, dynamic> json) =
