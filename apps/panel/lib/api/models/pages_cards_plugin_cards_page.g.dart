...
_$PagesCardsPluginCardsPageImpl _$$PagesCardsPluginCardsPageImplFromJson(
...
Map<String, dynamic> _$$PagesCardsPluginCardsPageImplToJson(
        _$PagesCardsPluginCardsPageImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
