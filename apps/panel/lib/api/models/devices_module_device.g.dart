...
_$DevicesModuleDeviceImpl _$$DevicesModuleDeviceImplFromJson(
    ...
    _$DevicesModuleDeviceImpl(
      ...
      controls: (json['controls'] as List<dynamic>)
          .map((e) =>
              DevicesModuleDeviceControl.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$DevicesModuleDeviceImplToJson(
        _$DevicesModuleDeviceImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
