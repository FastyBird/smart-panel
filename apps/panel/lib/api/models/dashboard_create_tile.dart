...
part 'dashboard_create_tile.freezed.dart';
part 'dashboard_create_tile.g.dart';

/// Base schema for creating a dashboard tile, containing shared attributes such as position and size.
@Freezed()
class DashboardCreateTile with _$DashboardCreateTile {
  const factory DashboardCreateTile({
    ...
    @Default(0)
    int colSpan,
  }) = _DashboardCreateTile;
  
  factory DashboardCreateTile.fromJson(Map<String, Object?> json) => _$DashboardCreateTileFromJson(json);
}
