...
_$DashboardModuleTileImpl _$$DashboardModuleTileImplFromJson(
        Map<String, dynamic> json) =>
    _$DashboardModuleTileImpl(
...
Map<String, dynamic> _$$DashboardModuleTileImplToJson(
        _$DashboardModuleTileImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
