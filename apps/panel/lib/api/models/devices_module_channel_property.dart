...
part 'devices_module_channel_property.freezed.dart';
part 'devices_module_channel_property.g.dart';
...
@Freezed()
class DevicesModuleChannelProperty with _$DevicesModuleChannelProperty {
  const factory DevicesModuleChannelProperty({
  ...
  }) = _DevicesModuleChannelProperty;
  
  factory DevicesModuleChannelProperty.fromJson(Map<String, Object?> json) => _$DevicesModuleChannelPropertyFromJson(json);
}
