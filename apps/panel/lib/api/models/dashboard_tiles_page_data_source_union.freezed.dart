...
class _$DashboardTilesPageDataSourceUnionDeviceChannelImpl
  ...
  @override
  String toString() {
    return 'DashboardTilesPageDataSourceUnion.deviceChannel(id: $id, type: $type, createdAt: $createdAt, updatedAt: $updatedAt, device: $device, channel: $channel, property: $property, icon: $icon, page: $page)';
  }
