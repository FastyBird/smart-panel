...
_$DashboardCardForecastWeatherTileImpl
    _$$DashboardCardForecastWeatherTileImplFromJson(
...
Map<String, dynamic> _$$DashboardCardForecastWeatherTileImplToJson(
        _$DashboardCardForecastWeatherTileImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
      'row': instance.row,
