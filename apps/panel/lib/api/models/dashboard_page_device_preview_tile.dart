...
part 'dashboard_page_device_preview_tile.freezed.dart';
part 'dashboard_page_device_preview_tile.g.dart';

/// A dashboard tile associated with a specific device.
@Freezed()
class DashboardPageDevicePreviewTile with _$DashboardPageDevicePreviewTile {
  const factory DashboardPageDevicePreviewTile({
    ...
    @Default(0)
    int colSpan,
  }) = _DashboardPageDevicePreviewTile;
  
  factory DashboardPageDevicePreviewTile.fromJson(Map<String, Object?> json) => _$DashboardPageDevicePreviewTileFromJson(json);
}
