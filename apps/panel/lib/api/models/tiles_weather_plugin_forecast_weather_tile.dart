...
part 'tiles_weather_plugin_forecast_weather_tile.freezed.dart';
part 'tiles_weather_plugin_forecast_weather_tile.g.dart';

/// A dashboard tile displaying a weather forecast.
@Freezed()
class TilesWeatherPluginForecastWeatherTile with _$TilesWeatherPluginForecastWeatherTile {
  const factory TilesWeatherPluginForecastWeatherTile({
    ...
    @Default(false)
    bool hidden,
  }) = _TilesWeatherPluginForecastWeatherTile;
  
  factory TilesWeatherPluginForecastWeatherTile.fromJson(Map<String, Object?> json) => _$TilesWeatherPluginForecastWeatherTileFromJson(json);
}
