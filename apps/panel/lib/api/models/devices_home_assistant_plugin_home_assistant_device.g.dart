...
_$DevicesHomeAssistantPluginHomeAssistantDeviceImpl
    _$$DevicesHomeAssistantPluginHomeAssistantDeviceImplFromJson(
...
Map<String, dynamic> _$$DevicesHomeAssistantPluginHomeAssistantDeviceImplToJson(
        _$DevicesHomeAssistantPluginHomeAssistantDeviceImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
