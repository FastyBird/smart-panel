...
part 'config_module_display.freezed.dart';
part 'config_module_display.g.dart';

/// Schema for display configuration, including brightness, dark mode, and screen lock behavior.
@Freezed()
class ConfigModuleDisplay with _$ConfigModuleDisplay {
  const factory ConfigModuleDisplay({
    ...
    @Default(true)
    bool screenSaver,
  }) = _ConfigModuleDisplay;
  
  factory ConfigModuleDisplay.fromJson(Map<String, Object?> json) => _$ConfigModuleDisplayFromJson(json);
}
