...
part 'dashboard_data_source.freezed.dart';
...
@Freezed()
class DashboardDataSource with _$DashboardDataSource {
  const factory DashboardDataSource({
  ...
  factory DashboardDataSource.fromJson(Map<String, Object?> json) => _$DashboardDataSourceFromJson(json);
}
