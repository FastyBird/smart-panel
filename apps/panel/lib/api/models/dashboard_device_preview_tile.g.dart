...
_$DashboardDevicePreviewTileImpl _$$DashboardDevicePreviewTileImplFromJson(
...
Map<String, dynamic> _$$DashboardDevicePreviewTileImplToJson(
        _$DashboardDevicePreviewTileImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
      'row': instance.row,
