...
part 'weather_module_geolocation.freezed.dart';
part 'weather_module_geolocation.g.dart';

/// Represents geographical location details, including city name, coordinates, and country information.
@Freezed()
class WeatherModuleGeolocation with _$WeatherModuleGeolocation {
  const factory WeatherModuleGeolocation({
  ...
  }) = _WeatherModuleGeolocation;
  
  factory WeatherModuleGeolocation.fromJson(Map<String, Object?> json) => _$WeatherModuleGeolocationFromJson(json);
}
