...
part 'devices_third_party_plugin_third_party_channel_property.freezed.dart';
part 'devices_third_party_plugin_third_party_channel_property.g.dart';

/// A Home Assistant properties used to communicate with Home Assistant instance.
@Freezed()
class DevicesThirdPartyPluginThirdPartyChannelProperty with _$DevicesThirdPartyPluginThirdPartyChannelProperty {
  const factory DevicesThirdPartyPluginThirdPartyChannelProperty({
  ...
  }) = _DevicesThirdPartyPluginThirdPartyChannelProperty;
  
  factory DevicesThirdPartyPluginThirdPartyChannelProperty.fromJson(Map<String, Object?> json) => _$DevicesThirdPartyPluginThirdPartyChannelPropertyFromJson(json);
}
