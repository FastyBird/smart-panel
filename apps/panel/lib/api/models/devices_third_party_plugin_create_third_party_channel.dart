...
part 'devices_third_party_plugin_create_third_party_channel.freezed.dart';
part 'devices_third_party_plugin_create_third_party_channel.g.dart';

/// The schema for creating a Home Assistant channel.
@Freezed()
class DevicesThirdPartyPluginCreateThirdPartyChannel with _$DevicesThirdPartyPluginCreateThirdPartyChannel {
  const factory DevicesThirdPartyPluginCreateThirdPartyChannel({
    ...
    String? description,
  }) = _DevicesThirdPartyPluginCreateThirdPartyChannel;
  
  factory DevicesThirdPartyPluginCreateThirdPartyChannel.fromJson(Map<String, Object?> json) => _$DevicesThirdPartyPluginCreateThirdPartyChannelFromJson(json);
}
