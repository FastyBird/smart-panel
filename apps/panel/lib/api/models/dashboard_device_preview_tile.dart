...
part 'dashboard_device_preview_tile.freezed.dart';
part 'dashboard_device_preview_tile.g.dart';

/// A dashboard tile associated with a specific device.
@Freezed()
class DashboardDevicePreviewTile with _$DashboardDevicePreviewTile {
  const factory DashboardDevicePreviewTile({
    ...
    @Default(0)
    int colSpan,
  }) = _DashboardDevicePreviewTile;
  
  factory DashboardDevicePreviewTile.fromJson(Map<String, Object?> json) => _$DashboardDevicePreviewTileFromJson(json);
}
