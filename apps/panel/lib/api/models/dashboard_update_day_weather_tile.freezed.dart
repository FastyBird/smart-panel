...
DashboardUpdateDayWeatherTile _$DashboardUpdateDayWeatherTileFromJson(
    Map<String, dynamic> json) {
  return _DashboardUpdateDayWeatherTile.fromJson(json);
}

/// @nodoc
mixin _$DashboardUpdateDayWeatherTile {
  ...
  /// Serializes this DashboardUpdateDayWeatherTile to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DashboardUpdateDayWeatherTile
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DashboardUpdateDayWeatherTileCopyWith<DashboardUpdateDayWeatherTile>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DashboardUpdateDayWeatherTileCopyWith<$Res> {
  factory $DashboardUpdateDayWeatherTileCopyWith(
          DashboardUpdateDayWeatherTile value,
          $Res Function(DashboardUpdateDayWeatherTile) then) =
      _$DashboardUpdateDayWeatherTileCopyWithImpl<$Res,
...
/// @nodoc
class _$DashboardUpdateDayWeatherTileCopyWithImpl<$Res,
        $Val extends DashboardUpdateDayWeatherTile>
    implements $DashboardUpdateDayWeatherTileCopyWith<$Res> {
  _$DashboardUpdateDayWeatherTileCopyWithImpl(this._value, this._then);
...
class __$$DashboardUpdateDayWeatherTileImplCopyWithImpl<$Res>
    extends _$DashboardUpdateDayWeatherTileCopyWithImpl<$Res,
...
class _$DashboardUpdateDayWeatherTileImpl
    implements _DashboardUpdateDayWeatherTile {
  ...
  @override
  String toString() {
    return 'DashboardUpdateDayWeatherTile(row: $row, col: $col, rowSpan: $rowSpan, colSpan: $colSpan, type: $type)';
  }
...
abstract class _DashboardUpdateDayWeatherTile
    implements DashboardUpdateDayWeatherTile {
  const factory _DashboardUpdateDayWeatherTile(
  ...
  factory _DashboardUpdateDayWeatherTile.fromJson(Map<String, dynamic> json) =
