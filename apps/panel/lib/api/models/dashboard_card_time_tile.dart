...
part 'dashboard_card_time_tile.freezed.dart';
part 'dashboard_card_time_tile.g.dart';

/// A dashboard tile associated with a specific device.
@Freezed()
class DashboardCardTimeTile with _$DashboardCardTimeTile {
  const factory DashboardCardTimeTile({
    ...
    @Default('clock')
    String type,
  }) = _DashboardCardTimeTile;
  
  factory DashboardCardTimeTile.fromJson(Map<String, Object?> json) => _$DashboardCardTimeTileFromJson(json);
}
