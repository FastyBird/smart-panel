...
part 'dashboard_page_day_weather_tile.freezed.dart';
part 'dashboard_page_day_weather_tile.g.dart';

/// A dashboard tile associated with a specific device.
@Freezed()
class DashboardPageDayWeatherTile with _$DashboardPageDayWeatherTile {
  const factory DashboardPageDayWeatherTile({
    ...
    @Default(0)
    int colSpan,
  }) = _DashboardPageDayWeatherTile;
  
  factory DashboardPageDayWeatherTile.fromJson(Map<String, Object?> json) => _$DashboardPageDayWeatherTileFromJson(json);
}
