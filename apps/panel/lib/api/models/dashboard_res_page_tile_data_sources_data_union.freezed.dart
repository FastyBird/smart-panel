...
class _$DashboardResPageTileDataSourcesDataUnionDeviceChannelImpl
  ...
  @override
  String toString() {
    return 'DashboardResPageTileDataSourcesDataUnion.deviceChannel(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, device: $device, channel: $channel, property: $property, icon: $icon, type: $type)';
  }
