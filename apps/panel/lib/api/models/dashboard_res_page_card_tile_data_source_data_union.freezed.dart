...
class _$DashboardResPageCardTileDataSourceDataUnionDeviceChannelImpl
  ...
  @override
  String toString() {
    return 'DashboardResPageCardTileDataSourceDataUnion.deviceChannel(id: $id, type: $type, createdAt: $createdAt, updatedAt: $updatedAt, device: $device, channel: $channel, property: $property, icon: $icon, tile: $tile)';
  }
