...
part 'system_module_display_info.freezed.dart';
part 'system_module_display_info.g.dart';

/// Schema for a information about the display resolution and current screen resolution.
@Freezed()
class SystemModuleDisplayInfo with _$SystemModuleDisplayInfo {
  const factory SystemModuleDisplayInfo({
  ...
  }) = _SystemModuleDisplayInfo;
  
  factory SystemModuleDisplayInfo.fromJson(Map<String, Object?> json) => _$SystemModuleDisplayInfoFromJson(json);
}
