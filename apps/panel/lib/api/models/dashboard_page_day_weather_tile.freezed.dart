...
class _$DashboardPageDayWeatherTileImpl
  ...
  @override
  String toString() {
    return 'DashboardPageDayWeatherTile(id: $id, row: $row, col: $col, dataSource: $dataSource, createdAt: $createdAt, updatedAt: $updatedAt, page: $page, rowSpan: $rowSpan, colSpan: $colSpan, type: $type)';
  }
...
abstract class _DashboardPageDayWeatherTile
  ...
  const factory _DashboardPageDayWeatherTile(
      ...
      final String type}) = _$DashboardPageDayWeatherTileImpl;
