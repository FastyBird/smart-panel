...
part 'weather_module_current_day.freezed.dart';
part 'weather_module_current_day.g.dart';

/// Schema for a specific day, including temperature, wind, and precipitation.
@Freezed()
class WeatherModuleCurrentDay with _$WeatherModuleCurrentDay {
  const factory WeatherModuleCurrentDay({
    ...
    num? temperatureMax,
  }) = _WeatherModuleCurrentDay;
  
  factory WeatherModuleCurrentDay.fromJson(Map<String, Object?> json) => _$WeatherModuleCurrentDayFromJson(json);
}
