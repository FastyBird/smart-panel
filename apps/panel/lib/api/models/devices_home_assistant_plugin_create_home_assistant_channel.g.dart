...
_$DevicesHomeAssistantPluginCreateHomeAssistantChannelImpl
    _$$DevicesHomeAssistantPluginCreateHomeAssistantChannelImplFromJson(
...
Map<String,
    dynamic> _$$DevicesHomeAssistantPluginCreateHomeAssistantChannelImplToJson(
        _$DevicesHomeAssistantPluginCreateHomeAssistantChannelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
