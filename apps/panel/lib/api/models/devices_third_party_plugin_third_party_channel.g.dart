...
_$DevicesThirdPartyPluginThirdPartyChannelImpl
    _$$DevicesThirdPartyPluginThirdPartyChannelImplFromJson(
...
Map<String, dynamic> _$$DevicesThirdPartyPluginThirdPartyChannelImplToJson(
        _$DevicesThirdPartyPluginThirdPartyChannelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
