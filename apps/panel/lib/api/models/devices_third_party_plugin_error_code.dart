...
@JsonEnum()
enum DevicesThirdPartyPluginErrorCode {
  @JsonValue(0)
  value0(0),
  @JsonValue(-80001)
  ...
  const DevicesThirdPartyPluginErrorCode(this.json);

  factory DevicesThirdPartyPluginErrorCode.fromJson(num json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
