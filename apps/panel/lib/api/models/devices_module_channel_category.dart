...
@JsonEnum()
enum DevicesModuleChannelCategory {
  @JsonValue('generic')
  generic('generic'),
  ...
  const DevicesModuleChannelCategory(this.json);

  factory DevicesModuleChannelCategory.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
