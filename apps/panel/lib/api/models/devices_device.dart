...
part 'devices_device.freezed.dart';
part 'devices_device.g.dart';
...
@Freezed()
class DevicesDevice with _$DevicesDevice {
  const factory DevicesDevice({
  ...
  factory DevicesDevice.fromJson(Map<String, Object?> json) => _$DevicesDeviceFromJson(json);
}
