...
part 'config_module_update_audio.freezed.dart';
part 'config_module_update_audio.g.dart';

/// Schema for partial update settings for audio configuration, allowing changes to speaker and microphone settings.
@Freezed()
class ConfigModuleUpdateAudio with _$ConfigModuleUpdateAudio {
  const factory ConfigModuleUpdateAudio({
  ...
  }) = _ConfigModuleUpdateAudio;
  
  factory ConfigModuleUpdateAudio.fromJson(Map<String, Object?> json) => _$ConfigModuleUpdateAudioFromJson(json);
}
