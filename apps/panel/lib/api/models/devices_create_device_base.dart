...
part 'devices_create_device_base.freezed.dart';
part 'devices_create_device_base.g.dart';
...
@Freezed()
class DevicesCreateDeviceBase with _$DevicesCreateDeviceBase {
  const factory DevicesCreateDeviceBase({
    ...
    String? description,
  }) = _DevicesCreateDeviceBase;
  
  factory DevicesCreateDeviceBase.fromJson(Map<String, Object?> json) => _$DevicesCreateDeviceBaseFromJson(json);
}
