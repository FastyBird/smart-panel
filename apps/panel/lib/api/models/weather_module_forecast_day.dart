...
import 'weather_module_weather.dart';
import 'weather_module_wind.dart';

part 'weather_module_forecast_day.freezed.dart';
part 'weather_module_forecast_day.g.dart';

/// Schema for a forecasted day, including temperature, wind, and precipitation.
@Freezed()
class WeatherModuleForecastDay with _$WeatherModuleForecastDay {
  const factory WeatherModuleForecastDay({
    ...
    required WeatherModuleWeather weather,

    /// Wind conditions at the location.
    required WeatherModuleWind wind,
    ...
    DateTime? moonset,
  }) = _WeatherModuleForecastDay;
  
  factory WeatherModuleForecastDay.fromJson(Map<String, Object?> json) => _$WeatherModuleForecastDayFromJson(json);
}
