...
class _$DashboardCardForecastWeatherTileImpl
  ...
  @override
  String toString() {
    return 'DashboardCardForecastWeatherTile(id: $id, type: $type, row: $row, col: $col, dataSource: $dataSource, createdAt: $createdAt, updatedAt: $updatedAt, card: $card, rowSpan: $rowSpan, colSpan: $colSpan)';
  }
