...
DashboardDayWeatherTile _$DashboardDayWeatherTileFromJson(
    Map<String, dynamic> json) {
  return _DashboardDayWeatherTile.fromJson(json);
}

/// @nodoc
mixin _$DashboardDayWeatherTile {
  ...
  $DashboardDayWeatherTileCopyWith<DashboardDayWeatherTile> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DashboardDayWeatherTileCopyWith<$Res> {
  factory $DashboardDayWeatherTileCopyWith(DashboardDayWeatherTile value,
          $Res Function(DashboardDayWeatherTile) then) =
      _$DashboardDayWeatherTileCopyWithImpl<$Res, DashboardDayWeatherTile>;
  @useResult
  $Res call(
      {String id,
      String type,
...
/// @nodoc
class _$DashboardDayWeatherTileCopyWithImpl<$Res,
        $Val extends DashboardDayWeatherTile>
    implements $DashboardDayWeatherTileCopyWith<$Res> {
  _$DashboardDayWeatherTileCopyWithImpl(this._value, this._then);
...
class __$$DashboardDayWeatherTileImplCopyWithImpl<$Res>
    extends _$DashboardDayWeatherTileCopyWithImpl<$Res,
