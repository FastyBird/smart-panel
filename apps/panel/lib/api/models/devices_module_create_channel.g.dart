...
_$DevicesModuleCreateChannelImpl _$$DevicesModuleCreateChannelImplFromJson(
...
Map<String, dynamic> _$$DevicesModuleCreateChannelImplToJson(
        _$DevicesModuleCreateChannelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
