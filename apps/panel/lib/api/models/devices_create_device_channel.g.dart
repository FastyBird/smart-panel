...
_$DevicesCreateDeviceChannelImpl _$$DevicesCreateDeviceChannelImplFromJson(
...
Map<String, dynamic> _$$DevicesCreateDeviceChannelImplToJson(
        _$DevicesCreateDeviceChannelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
