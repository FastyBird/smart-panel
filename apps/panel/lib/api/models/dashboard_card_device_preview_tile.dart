...
part 'dashboard_card_device_preview_tile.freezed.dart';
part 'dashboard_card_device_preview_tile.g.dart';

/// A dashboard tile associated with a specific device.
@Freezed()
class DashboardCardDevicePreviewTile with _$DashboardCardDevicePreviewTile {
  const factory DashboardCardDevicePreviewTile({
    ...
    @Default(0)
    int colSpan,
  }) = _DashboardCardDevicePreviewTile;
  
  factory DashboardCardDevicePreviewTile.fromJson(Map<String, Object?> json) => _$DashboardCardDevicePreviewTileFromJson(json);
}
