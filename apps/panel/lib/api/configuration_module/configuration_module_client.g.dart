...
part of 'configuration_module_client.dart';
...
class _ConfigurationModuleClient implements ConfigurationModuleClient {
  _ConfigurationModuleClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<ConfigModuleResSection>> getConfigModuleConfigSection({
    ...
    final _options = _setStreamType<HttpResponse<ConfigModuleResSection>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/config-module/config/${section.name}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<HttpResponse<ConfigModuleResPlugin>> getConfigModuleConfigPlugin({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ConfigModuleResPlugin>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ConfigModuleResPlugin _value;
    try {
      _value = ConfigModuleResPlugin.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<ConfigModuleResPlugin>> updateConfigModuleConfigPlugin({
    required String plugin,
    ConfigModuleReqUpdatePlugin? body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
