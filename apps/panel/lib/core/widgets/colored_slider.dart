    ...
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
          vertical: widget.showThumb && widget.vertical ? thumbWidth / 2 : 0,
          horizontal: widget.showThumb && !widget.vertical ? thumbWidth / 2 : 0,
        ),
        child: Stack(
...
class RoundedRectTrackShape extends SliderTrackShape {
  ...
  const RoundedRectTrackShape({required this.borderRadius});
