...
class SkyEffectRain extends StatefulWidget {
	final int intensity;
	final bool isNight;
	...
	@override
	State<SkyEffectRain> createState() => _SkyEffectRainState();
}
	...
	void paint(Canvas canvas, Size size) {
		for (final d in drops) {
			...
			canvas.drawLine(
				...
				Paint()
					..color = (isNight ? const Color(0xFF8899AA) : const Color(0xFFABBFD0)).withValues(alpha: d.opacity)
					..strokeWidth = 1.2
...
class SkyEffectSnow extends StatefulWidget {
	final int intensity;
	final bool isNight;
	...
	@override
	State<SkyEffectSnow> createState() => _SkyEffectSnowState();
}
...
class SkyEffectWind extends StatefulWidget {
	final bool isNight;
	...
	@override
	State<SkyEffectWind> createState() => _SkyEffectWindState();
}

class _SkyEffectWindState extends State<SkyEffectWind> with SingleTickerProviderStateMixin {
	late final AnimationController _ctrl;
...
class SkyEffectLightning extends StatefulWidget {
	const SkyEffectLightning({super.key});

	@override
	State<SkyEffectLightning> createState() => _SkyEffectLightningState();
}

class _SkyEffectLightningState extends State<SkyEffectLightning> with SingleTickerProviderStateMixin {
	late final AnimationController _ctrl;
	...
	Widget build(BuildContext context) {
		return AnimatedBuilder(
			...
			builder: (_, __) => IgnorePointer(
				child: Container(color: Colors.white.withValues(alpha: _ctrl.value * _flashOpacity)),
			),
		);
	}
}
...
class SkyEffectFog extends StatelessWidget {
	final bool isNight;
