...
export class TileDataSourceTypeConstraintValidator implements ValidatorConstraintInterface {
...
export const ValidateTileDataSources = (validationOptions?: ValidationOptions) => {
	return function (object: object, propertyName: string) {
		registerDecorator({
			name: 'ValidateTileDataSources',
			target: object.constructor,
			propertyName,
			options: validationOptions,
			constraints: [],
			validator: TileDataSourceTypeConstraintValidator,
		});
	};
};
