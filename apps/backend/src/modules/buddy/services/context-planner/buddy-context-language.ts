...
const CONDITIONAL_OUTCOME_OBJECT_GAP_GERUND_PATTERN_SOURCE = String.raw`(?:activating|adjusting|cleaning|closing|controlling|dimming|disabling|fixing|locking|monitoring|opening|recording|repairing|setting|switching|triggering|turning|unlocking|using|watching)`;
