...
const CONDITIONAL_OUTCOME_BARE_SUBJECT_COMMAND_PATTERN_SOURCE = String.raw`(?:${ACTION_SIGNAL_PATTERN_SOURCE}|${CONDITIONAL_OUTCOME_IMPERATIVE_MODIFIER_PATTERN_SOURCE}|also|ask|get|have|help|let|only|please|tell)`;
