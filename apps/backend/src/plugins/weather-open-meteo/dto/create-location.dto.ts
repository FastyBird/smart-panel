...
@ApiSchema({ name: 'WeatherOpenMeteoPluginCreateLocation' })
export class CreateOpenMeteoLocationDto extends CreateLocationDto {
	@ApiProperty({
	...
	readonly type: typeof WEATHER_OPEN_METEO_PLUGIN_TYPE;
