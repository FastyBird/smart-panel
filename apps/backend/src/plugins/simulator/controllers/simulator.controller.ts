...
import { SIMULATOR_PLUGIN_API_TAG_NAME, SIMULATOR_PLUGIN_NAME, SIMULATOR_TYPE } from '../simulator.constants';

@ApiTags(SIMULATOR_PLUGIN_API_TAG_NAME)
@Controller('simulator')
export class SimulatorController {
	private readonly logger: ExtensionLoggerService = createExtensionLogger(SIMULATOR_PLUGIN_NAME, 'SimulatorController');
	...
	@ApiOperation({
		...
		operationId: 'get-simulator-plugin-categories',
	})
	...
	@ApiOperation({
		...
		operationId: 'create-simulator-plugin-device',
	})
	@ApiBody({
	...
	@ApiOperation({
		...
		operationId: 'simulate-simulator-plugin-property-value',
	})
	@ApiParam({
		name: 'deviceId',
	...
	@ApiOperation({
		...
		operationId: 'simulate-simulator-plugin-connection-state',
	})
	@ApiParam({
		name: 'deviceId',
		description: 'Device UUID',
	...
	@ApiOperation({
		...
		operationId: 'simulate-simulator-plugin-all-values',
	})
	@ApiParam({
		name: 'deviceId',
		description: 'Device UUID',
