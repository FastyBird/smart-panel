...
export class ScenarioCommand extends CommandRunner {
	private readonly logger = createExtensionLogger(SIMULATOR_PLUGIN_NAME, 'ScenarioCommand');
	...
	private async runInteractive(): Promise<void> {
		...
		const existingDevices = await this.devicesService.findAll<SimulatorDeviceEntity>(SIMULATOR_TYPE);
