...
@ApiSchema({ name: 'WeatherOpenweathermapOnecallPluginDataConfig' })
export class OpenWeatherMapOneCallConfigModel extends PluginConfigModel {
	@ApiProperty({
	...
	@Expose()
	@IsString()
	type: string = WEATHER_OPENWEATHERMAP_ONECALL_PLUGIN_NAME;
