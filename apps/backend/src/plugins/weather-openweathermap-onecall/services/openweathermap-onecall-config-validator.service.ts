...
@Injectable()
export class OpenWeatherMapOneCallConfigValidatorService implements IPluginConfigValidator, OnModuleInit {
	readonly pluginType = WEATHER_OPENWEATHERMAP_ONECALL_PLUGIN_NAME;
