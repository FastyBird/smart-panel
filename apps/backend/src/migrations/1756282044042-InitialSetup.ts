...
export class InitialSetup1756282044042 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "system_module_displays_profiles" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" datetime, "uid" varchar NOT NULL, "screenWidth" integer NOT NULL, "screenHeight" integer NOT NULL, "pixelRatio" float NOT NULL, "unitSize" float NOT NULL, "rows" integer NOT NULL, "cols" integer NOT NULL, "primary" boolean NOT NULL DEFAULT (0))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "users_module_displays_instances" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" datetime, "uid" varchar NOT NULL, "mac" varchar NOT NULL, "version" varchar NOT NULL, "build" varchar NOT NULL, "userId" varchar, "displayProfileId" varchar, CONSTRAINT "REL_feb2bebd9f9d41d9968f87a8e6" UNIQUE ("userId"), CONSTRAINT "REL_f825a5cbdb979cf62e039b4134" UNIQUE ("displayProfileId"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_dashboard_module_pages" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" datetime, "title" varchar NOT NULL, "icon" varchar, "order" integer NOT NULL DEFAULT (0), "showTopBar" boolean NOT NULL DEFAULT (1), "tileSize" float, "rows" integer, "cols" integer, "type" varchar NOT NULL, "displayId" varchar, "deviceId" varchar, CONSTRAINT "FK_67e3822d59f77a2e250d19d4480" FOREIGN KEY ("displayId") REFERENCES "system_module_displays_profiles" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_59a4de274605ffa12dcac2c81d2" FOREIGN KEY ("deviceId") REFERENCES "devices_module_devices" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_users_module_displays_instances" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" datetime, "uid" varchar NOT NULL, "mac" varchar NOT NULL, "version" varchar NOT NULL, "build" varchar NOT NULL, "userId" varchar, "displayProfileId" varchar, CONSTRAINT "REL_feb2bebd9f9d41d9968f87a8e6" UNIQUE ("userId"), CONSTRAINT "REL_f825a5cbdb979cf62e039b4134" UNIQUE ("displayProfileId"), CONSTRAINT "FK_feb2bebd9f9d41d9968f87a8e6e" FOREIGN KEY ("userId") REFERENCES "users_module_users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_f825a5cbdb979cf62e039b4134f" FOREIGN KEY ("displayProfileId") REFERENCES "system_module_displays_profiles" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`,
		);
		await queryRunner.query(
			`INSERT INTO "temporary_users_module_displays_instances"("id", "createdAt", "updatedAt", "uid", "mac", "version", "build", "userId", "displayProfileId") SELECT "id", "createdAt", "updatedAt", "uid", "mac", "version", "build", "userId", "displayProfileId" FROM "users_module_displays_instances"`,
		);
		await queryRunner.query(`DROP TABLE "users_module_displays_instances"`);
		await queryRunner.query(
			`ALTER TABLE "temporary_users_module_displays_instances" RENAME TO "users_module_displays_instances"`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_auth_module_tokens" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" datetime, "hashedToken" varchar NOT NULL, "expiresAt" datetime, "revoked" boolean NOT NULL DEFAULT (0), "name" varchar, "description" varchar, "type" varchar NOT NULL, "ownerId" varchar, "parentId" varchar, CONSTRAINT "FK_506ec5c044fcfe86eedd61fcc2a" FOREIGN KEY ("ownerId") REFERENCES "users_module_users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_f23eec7f267f33cad8d4b0b8301" FOREIGN KEY ("parentId") REFERENCES "auth_module_tokens" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`,
		);
		await queryRunner.query(
			`INSERT INTO "temporary_auth_module_tokens"("id", "createdAt", "updatedAt", "hashedToken", "expiresAt", "revoked", "name", "description", "type", "ownerId", "parentId") SELECT "id", "createdAt", "updatedAt", "hashedToken", "expiresAt", "revoked", "name", "description", "type", "ownerId", "parentId" FROM "auth_module_tokens"`,
		);
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`INSERT INTO "auth_module_tokens"("id", "createdAt", "updatedAt", "hashedToken", "expiresAt", "revoked", "name", "description", "type", "ownerId", "parentId") SELECT "id", "createdAt", "updatedAt", "hashedToken", "expiresAt", "revoked", "name", "description", "type", "ownerId", "parentId" FROM "temporary_auth_module_tokens"`,
		);
		...
		await queryRunner.query(
			`ALTER TABLE "users_module_displays_instances" RENAME TO "temporary_users_module_displays_instances"`,
		);
		await queryRunner.query(
			`CREATE TABLE "users_module_displays_instances" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" datetime, "uid" varchar NOT NULL, "mac" varchar NOT NULL, "version" varchar NOT NULL, "build" varchar NOT NULL, "userId" varchar, "displayProfileId" varchar, CONSTRAINT "REL_feb2bebd9f9d41d9968f87a8e6" UNIQUE ("userId"), CONSTRAINT "REL_f825a5cbdb979cf62e039b4134" UNIQUE ("displayProfileId"))`,
		);
		await queryRunner.query(
			`INSERT INTO "users_module_displays_instances"("id", "createdAt", "updatedAt", "uid", "mac", "version", "build", "userId", "displayProfileId") SELECT "id", "createdAt", "updatedAt", "uid", "mac", "version", "build", "userId", "displayProfileId" FROM "temporary_users_module_displays_instances"`,
		);
		await queryRunner.query(`DROP TABLE "temporary_users_module_displays_instances"`);
		await queryRunner.query(`DROP INDEX "IDX_9237609236d02277e75bb98556"`);
		await queryRunner.query(
		...
		await queryRunner.query(`DROP INDEX "IDX_36e8c03f4a3b3c12bf52d211c9"`);
		await queryRunner.query(`DROP TABLE "dashboard_module_pages"`);
		await queryRunner.query(`DROP TABLE "system_module_displays_profiles"`);
		await queryRunner.query(`DROP INDEX "IDX_98ffd1e6ff9c4463c3e7d9a9c7"`);
		await queryRunner.query(`DROP TABLE "devices_module_channels_properties"`);
		await queryRunner.query(`DROP TABLE "devices_module_channels_controls"`);
		await queryRunner.query(`DROP INDEX "IDX_a654e0cabea37168a1a967ab5d"`);
