...
export class AddSpaceClimateRoles1736000000000 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`
			CREATE INDEX "IDX_spaces_climate_roles_channelId" ON "spaces_module_climate_roles" ("channelId")
		`);
	}
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`DROP INDEX IF EXISTS "IDX_spaces_climate_roles_channelId"`);
