...
import type { IShellyNgDeviceAddForm } from '../schemas/devices.types';
...
const { categoriesOptions, model, formEl, formChanged, submit, formResult } = useDeviceAddForm<IShellyNgDeviceAddForm>({
	id: props.id,
	type: DEVICES_SHELLY_NG_TYPE,
});

const rules = reactive<FormRules<IShellyNgDeviceAddForm>>({
