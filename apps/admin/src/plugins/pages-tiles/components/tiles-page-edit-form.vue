...
import { ElAlert, ElButton, ElCol, ElDivider, ElForm, ElFormItem, ElInput, ElInputNumber, ElRow, type FormRules } from 'element-plus';
...
const { model, formEl, formChanged, submit, formResult } = usePageEditForm<ITilesPageEditForm>({ page: props.page });

const rules = reactive<FormRules<ITilesPageEditForm>>({
