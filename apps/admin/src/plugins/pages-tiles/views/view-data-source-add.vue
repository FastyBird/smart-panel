<template>
	<app-bar-heading teleport>
		...
		<template #title>
			{{ t('pagesTilesPlugin.headings.pages.addDataSource') }}
		</template>

		<template #subtitle>
			{{ t('pagesTilesPlugin.subHeadings.pages.addDataSource') }}
		</template>
	</app-bar-heading>
...
useMeta({
	title: t('pagesTilesPlugin.meta.pages.addDataSource.title'),
});
...
const breadcrumbs = computed<{ label: string; route: RouteLocationResolvedGeneric }[]>(
	(): { label: string; route: RouteLocationResolvedGeneric }[] => {
		...
		items.push({
			label: t('pagesTilesPlugin.breadcrumbs.pages.addDataSource', { page: props.page?.title }),
