<template>
	<app-bar-heading teleport>
		...
		<template #title>
			{{ t('pagesTilesPlugin.headings.pages.editDataSource') }}
		</template>

		<template #subtitle>
			{{ t('pagesTilesPlugin.subHeadings.pages.editDataSource') }}
		</template>
	</app-bar-heading>
	...
	<div
		...
		:element-loading-text="t('pagesTilesPlugin.texts.dataSources.loadingDataSource')"
...
const breadcrumbs = computed<{ label: string; route: RouteLocationResolvedGeneric }[]>(
	(): { label: string; route: RouteLocationResolvedGeneric }[] => {
		...
		items.push({
			label: t('pagesTilesPlugin.breadcrumbs.pages.editDataSource', { page: props.page?.title }),
