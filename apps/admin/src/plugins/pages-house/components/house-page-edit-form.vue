...
import type { IHousePageEditForm } from '../schemas/pages.types';

defineOptions({
	name: 'HousePageEditForm',
});
...
const { model, formEl, formChanged, submit, formResult } = usePageEditForm<IHousePageEditForm>({ page: props.page });

const rules = reactive<FormRules<IHousePageEditForm>>({
