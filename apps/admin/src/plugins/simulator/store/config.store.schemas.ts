...
import { SIMULATOR_PLUGIN_NAME, SIMULATOR_CONNECTION_STATES } from '../simulator.constants';

type ApiUpdateConfig = {
	type: typeof SIMULATOR_PLUGIN_NAME;
	enabled?: boolean;
...
export const SimulatorConfigUpdateReqSchema: ZodType<ApiUpdateConfig> = ConfigPluginUpdateReqSchema.and(
	z.object({
		type: z.literal(SIMULATOR_PLUGIN_NAME),
