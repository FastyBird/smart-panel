...
import { DATA_SOURCES_WEATHER_CURRENT_TYPE, WeatherDataField } from '../data-sources-weather.constants';
import type { ICurrentWeatherDataSourceAddForm } from '../schemas/data-sources.types';

defineOptions({
	name: 'CurrentWeatherDataSourceAddForm',
});
...
const { model, formEl, formChanged, submit, formResult } = useDataSourceAddForm<ICurrentWeatherDataSourceAddForm>({
	id: props.id,
...
const rules = reactive<FormRules<ICurrentWeatherDataSourceAddForm>>({
