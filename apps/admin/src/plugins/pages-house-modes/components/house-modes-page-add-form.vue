...
import type { IHouseModesPageAddForm } from '../schemas/pages.types';

defineOptions({
	name: 'HouseModesPageAddForm',
});
...
const { model, formEl, formChanged, submit, formResult } = usePageAddForm<IHouseModesPageAddForm>({
	id: props.id,
	type: PAGES_HOUSE_MODES_TYPE,
});

const rules = reactive<FormRules<IHouseModesPageAddForm>>({
