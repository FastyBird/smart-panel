...
import type { IZigbeeHerdsmanDeviceEditForm } from '../schemas/devices.types';
import type { IZigbeeHerdsmanDevice } from '../store/devices.store.types';

import type { IZigbeeHerdsmanDeviceEditFormProps } from './zigbee-herdsman-device-edit-form.types';

defineOptions({
	name: 'ZigbeeHerdsmanDeviceEditForm',
});

const props = withDefaults(defineProps<IZigbeeHerdsmanDeviceEditFormProps>(), {
...
const { categoriesOptions, model, formEl, formChanged, submit, formResult } = useDeviceEditForm<IZigbeeHerdsmanDeviceEditForm>({
	device: props.device as IZigbeeHerdsmanDevice,
});

const rules = reactive<FormRules<IZigbeeHerdsmanDeviceEditForm>>({
