...
defineOptions({
	name: 'DeviceChannelDataSourceAddForm',
});
...
const {
	properties,
	fetchProperties,
	areLoading: loadingProperties,
} = useChannelsProperties({ channelId: computed(() => model.channel || undefined) });

const rules = reactive<FormRules<IDeviceChannelDataSourceAddForm>>({
