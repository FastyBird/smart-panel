...
import type { ICardsPageEditForm } from '../schemas/pages.types';

defineOptions({
	name: 'CardsPageEditForm',
});
...
const { model, formEl, formChanged, submit, formResult } = usePageEditForm<ICardsPageEditForm>({ page: props.page });

const rules = reactive<FormRules<ICardsPageEditForm>>({
