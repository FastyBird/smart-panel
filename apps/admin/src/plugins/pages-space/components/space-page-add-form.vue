...
import type { ISpacePageAddForm } from '../schemas/pages.types';

defineOptions({
	name: 'SpacePageAddForm',
});
...
const { model, formEl, formChanged, submit, formResult } = usePageAddForm<ISpacePageAddForm>({
	id: props.id,
...
const rules = reactive<FormRules<ISpacePageAddForm>>({
