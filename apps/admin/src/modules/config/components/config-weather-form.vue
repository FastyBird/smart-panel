<template>
	...
	>
		...
		<el-form-item
			v-if="model.locationType === ConfigModuleWeatherLatLonLocation_type.lat_lon"
		...
		<el-form-item
			v-if="model.locationType === ConfigModuleWeatherCityNameLocation_type.city_name"
		...
		<el-form-item
			v-if="model.locationType === ConfigModuleWeatherCityIdLocation_type.city_id"
		...
		<el-form-item
			v-if="model.locationType === ConfigModuleWeatherZipCodeLocation_type.zip_code"
...
type CityGeolocation = components['schemas']['WeatherModuleCityGeolocation'];
type ZipGeolocation = components['schemas']['WeatherModuleZipGeolocation'];
...
const onMapClick = (e: { latlng: { lat: number; lng: number } }): void => {
	if (model.locationType !== ConfigModuleWeatherLatLonLocation_type.lat_lon) {
		return;
	}
...
const onUseMyLocation = (): void => {
	...
	navigator.geolocation.getCurrentPosition(
		(pos) => {
			...
			model.locationType = ConfigModuleWeatherLatLonLocation_type.lat_lon;
...
const onGeolocateLocation = async (query: string): Promise<void> => {
	if (query) {
		...
		if (model.locationType === ConfigModuleWeatherCityNameLocation_type.city_name) {
		...
		} else if (model.locationType === ConfigModuleWeatherZipCodeLocation_type.zip_code) {
...
onBeforeMount(async (): Promise<void> => {
	...
	} else if (model.locationType === ConfigModuleWeatherCityIdLocation_type.city_id) {
