...
import { type IDeviceAddForm, useDeviceAddForm } from '../../composables';
...
const { categoriesOptions, model, formEl, formChanged, submit, formResult } = useDeviceAddForm(props.id, props.type);
