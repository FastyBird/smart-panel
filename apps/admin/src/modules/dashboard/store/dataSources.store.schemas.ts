...
type ApiCreateDataSource = components['schemas']['DashboardCreateDataSource'];
type ApiUpdateDataSource = components['schemas']['DashboardUpdateDataSource'];
type ApiDataSource = components['schemas']['DashboardDataSource'];
