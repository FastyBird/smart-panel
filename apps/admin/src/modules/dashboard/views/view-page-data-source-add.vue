<template>
	<app-bar-heading teleport>
		...
		<template #title>
			{{ t('dashboardModule.headings.pages.addDataSource') }}
		</template>

		<template #subtitle>
			{{ t('dashboardModule.subHeadings.pages.addDataSource') }}
		</template>
	</app-bar-heading>
...
import type { IViewPageDataSourceAddProps } from './view-page-data-source-add.types';

defineOptions({
	name: 'ViewPageDataSourceAdd',
});

const props = defineProps<IViewPageDataSourceAddProps>();
...
useMeta({
	title: t('dashboardModule.meta.pages.addDataSource.title'),
});
...
const breadcrumbs = computed<{ label: string; route: RouteLocationResolvedGeneric }[]>(
	(): { label: string; route: RouteLocationResolvedGeneric }[] => {
		...
		items.push({
			label: t('dashboardModule.breadcrumbs.pages.addDataSource'),
