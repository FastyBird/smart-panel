export { default as StepWelcome } from './step-welcome.vue';
export { default as StepAccount } from './step-account.vue';
export { default as StepLocation } from './step-location.vue';
