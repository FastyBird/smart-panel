	...
	<div class="flex w-full">
		...
		>
			<el-input
				...
				:placeholder="t('weatherModule.fields.locations.search.placeholder')"
...
import type { ILocationsFilterProps } from './locations-filter.types';

defineOptions({
	name: 'LocationsFilter',
});

const props = defineProps<ILocationsFilterProps>();
