	...
	<div class="flex flex-col h-full">
		<template v-if="isProviderNotConfigured">
			<div class="flex items-center justify-center h-full">
				<el-result
					icon="warning"
					:title="t('buddyModule.texts.providerNotConfigured')"
					:sub-title="t('buddyModule.texts.providerNotConfiguredHint')"
				>
					<template #extra>
						<el-button
							type="primary"
...
import { ElAlert, ElButton, ElEmpty, ElIcon, ElInput, ElResult, ElScrollbar } from 'element-plus';
