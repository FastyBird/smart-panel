...
export interface components {
	schemas: {
		...
		DashboardTilesPage: components['schemas']['DashboardPageBase'] & {
			...
			tiles: (
				| components['schemas']['DashboardPageDeviceTile']
				| components['schemas']['DashboardPageTimeTile']
				| components['schemas']['DashboardPageDayWeatherTile']
				| components['schemas']['DashboardPageForecastWeatherTile']
			)[];
		...
		DashboardCard: {
			...
			tiles: (
				| components['schemas']['DashboardCardDeviceTile']
				| components['schemas']['DashboardCardTimeTile']
				| components['schemas']['DashboardCardDayWeatherTile']
				| components['schemas']['DashboardCardForecastWeatherTile']
			)[];
