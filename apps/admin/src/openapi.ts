    ...
    "/config-module/config/{section}": {
        parameters: {
            ...
            path: {
                ...
                section: PathsConfigModuleConfigSectionParametersParametersPathSection;
            };
            cookie?: never;
        };
        /**
...
export interface components {
    schemas: {
        ...
        ConfigModuleWeather: {
             ...
             * @enum {string}
             */
            location_type: PathsWeatherModuleWeatherCurrentGetParametersQueryLocation_type;
            /**
...
export enum PathsWeatherModuleWeatherCurrentGetParametersQueryLocation_type {
    lat_lon = "lat_lon",
    city_name = "city_name",
    city_id = "city_id",
    zip_code = "zip_code"
