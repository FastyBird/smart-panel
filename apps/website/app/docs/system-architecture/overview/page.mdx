...
- Users configuring devices manually through the Admin interface
...
👉 Head over to the **[Supported Devices](/docs/system-architecture/supported-devices/overview)** section to explore each device category and its associated capabilities.
