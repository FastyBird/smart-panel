...
<Callout type="warning">
	The individual channel specification pages listed below are auto-generated from YAML definitions. If some links are
	not working, run `pnpm --filter @fastybird/smart-panel-website run generate:docs` to generate them.
</Callout>
...
- [Air Quality](/docs/system-architecture/supported-channels/air-quality-channel) – Reports overall AQI and quality level.
...
- [Gas](/docs/system-architecture/supported-channels/gas-channel) – Detects gas presence for safety.
...
- [Dehumidifier](/docs/system-architecture/supported-channels/dehumidifier-channel) – Controls dehumidifier settings and modes.
...
- [Humidifier](/docs/system-architecture/supported-channels/humidifier-channel) – Controls humidifier settings and modes.
...
- [Filter](/docs/system-architecture/supported-channels/filter-channel) – Monitors filter status and remaining life.
- [Flow](/docs/system-architecture/supported-channels/flow-channel) – Monitors flow rate of liquids or gases (e.g., water or air).
- [Robotic Vacuum](/docs/system-architecture/supported-channels/robotic-vacuum-channel) – Handles control and status reporting for robotic vacuum devices.
