...
Provides a qualitative assessment of the leak severity:

- Possible values:
    - `bright`: Minimal leak detected.
    - `moderate`: Moderate leak detected.
    - `dusky`: Significant leak detected.
    - `dark`: Severe leak detected.
