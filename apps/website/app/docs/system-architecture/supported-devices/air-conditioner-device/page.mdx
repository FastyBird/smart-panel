...
<Callout type="info">
	**Device Category**: <code>air_conditioner</code>
</Callout>

The **Air Conditioner** is a smart cooling system that can monitor temperature and humidity, adjust fan speed, and optionally
track energy usage or detect leaks. It’s ideal for climate control setups where precise regulation and efficiency are key.
...
|----------------------|--------------------------------------------------------------------------------|--------------|----------------------------------------------------------------------------------------|
| `cooler`             | Controls the cooling functionality of the air conditioner.                     | No           | [See details](/docs/system-architecture/supported-channels/cooler-channel)             |
...
| `heater`            | Adds heating capability to the device.         | No           | [See details](/docs/system-architecture/supported-channels/heater-channel)            |
