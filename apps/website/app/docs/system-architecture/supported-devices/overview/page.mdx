...
<Callout type="warning">
	The individual device specification pages listed below are auto-generated from YAML definitions. If some links are
...
- [Heating Unit](/docs/system-architecture/supported-devices/heating-unit-device)
Space or room heating systems with temperature and energy management capabilities.
...
- [Water Heater](/docs/system-architecture/supported-devices/water-heater-device)
Water heating systems with temperature control and optional leak detection.
