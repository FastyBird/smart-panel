...
|----------------------|--------------------------------------------------------------------------------------|--------------|----------------------------------------------------------------------------------------|
| `speaker`            | Manages the speaker's audio output capabilities, including volume and active status. | Yes          | [See details](/docs/system-architecture/supported-channels/speaker-channel)            |
...
| `media_input`       | Allows input of media data, such as audio streams, for playback.        | No           | [See details](/docs/system-architecture/supported-channels/media-input-channel)       |
| `media_playback`    | Controls media playback functionality, including play, pause, and stop. | No           | [See details](/docs/system-architecture/supported-channels/media-playback-channel)    |
