...
The experimental Homey integration connects Smart Panel to a Homey Self-Hosted Server (SHS) over its local HTTP API. It imports logical devices already managed by Homey, lets an administrator review and adopt
