...
3. Open **Config → Plugins → Homey**, choose **Cloud**, and enter the client ID, client secret, and exact registered
   redirect URL. The client secret field is write-only: leaving it blank later preserves the stored value.
