...
<Callout type="info">
  **Local Homey SHS support is validated for SHS 13.4.0 and 13.4.1 over HTTP
  port 4859.** The validation matrix covers sanitized inventory, capability
  writes and ordered events, credential rotation and permission failures,
