...
<Steps>
	...
	Open [Raspberry Pi Imager](https://www.raspberrypi.com/software/), select **Use custom**, and
	choose the downloaded `.img.xz` file. Select your SD card and click **Write**.
