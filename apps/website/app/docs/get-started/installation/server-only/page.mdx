...
<Steps>
	...
	The backend requires **Node.js 24** or higher. Use the official NodeSource setup script:
	...
	<Callout type="warning">
		The output should show `v24.x.x` or higher. If you see an older version, remove it and
