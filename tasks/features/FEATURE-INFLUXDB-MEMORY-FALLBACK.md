...
- [x] Admin UI shows a warning banner: "InfluxDB not available — historical data disabled" (now delivered as a notifications-module issue through the storage fallback monitor instead of a dedicated banner; PR #938 - see docs/notifications.md)
