...
- **The six closed-loop categories** stay blocked, as [the design's v1 boundary](../../docs/superpowers/specs/2026-07-31-virtual-devices-design.md#v1-category-boundary) sets out. Unblocking them needs a control loop with hysteresis and minimum cycle protection, plus user-settable setpoints as owned properties — the schema already accommodates the latter. Tracked as [`FEATURE-DEVICE-VIRTUAL-CONTROLLER`](../features/FEATURE-DEVICE-VIRTUAL-CONTROLLER.md).
